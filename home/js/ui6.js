    ...
    return{
        ...
        event(){
            ...
            document.body.onscroll = function(){
                ...
                if(scroll > 1600){
                    $('.txt3').delay(500).animate({ top: 300,opacity:1 } ,1000);
                    $('.pic2').delay(500).animate({ top: 90,} ,1000);
                }
                if(scroll > 770){
                    $('.pic').delay(500).animate({ top: 30,} ,1000);
                    $('.txt').delay(500).animate({ top: 300,opacity:1 } ,1000);
                }
                if(scroll > 2520){
                    $('.pic3').delay(500).animate({ top: 30,} ,1000);
                    $('.txt4').delay(500).animate({ top: 300,opacity:1 } ,1000);
                }
                if(scroll > 3420){
